    ...
    <div className="flex items-center p-[5%]  w-full justify-center">
      <Link href={`/products/${id}`}>
        ...
        >
          ...
          <h1 className=" flex items-center justify-center gap-1 fixed bottom-9 3xl:bottom-10 left-[75px] 2xl:left-[25%] 3xl:left-[30%] group-hover:bottom-5 group-hover:left-[28px]">
            Add to cart <RxArrowRight />
          </h1>
          <h1 className="fixed bottom-9 3xl:bottom-10 right-[75px] 2xl:right-[25%] 3xl:right-[30%] group-hover:bottom-5 group-hover:right-[28px]">
            Rating : {rating}
          </h1>
        </div>
      </Link>
